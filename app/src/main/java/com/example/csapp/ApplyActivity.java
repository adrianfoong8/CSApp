    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivSelfie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(intent, "Select Selfie"),
                        IMAGE_REQUEST_CODE);
            }
        });
        ...
        mProgressDialog = new ProgressDialog(ApplyActivity.this);
    ...
    private void uploadDataToFirebase() {
        if (mFilePathUri != null) {
            ...
            StorageReference storageReference2 = mStorageReference.child(mStoragePath +
                    "selfie" + "." + getFileExtention(mFilePathUri));
            storageReference2.putFile(mFilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            startActivity(new Intent(ApplyActivity.this, Apply2Activity.class));
                            finish();
                        }
                    })
